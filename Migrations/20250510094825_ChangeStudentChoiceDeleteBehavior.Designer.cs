...
namespace StudentEmplacementApp.Migrations
{
    ...
    [Migration("20250510094825_ChangeStudentChoiceDeleteBehavior")]
    partial class ChangeStudentChoiceDeleteBehavior
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentEmplacementApp.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StudentEmplacementApp.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StudentEmplacementApp.Models.Student", b =>
                {
                    b.HasOne("StudentEmplacementApp.Models.User", "User")
                        .WithOne("Student")
                        .HasForeignKey("StudentEmplacementApp.Models.Student", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
